                ...
                <div className="homeContainer page-title-section">
                    <div className="row">
                        <div className="col-sm-12 text-center">
                            <h1 className="large bold h1">STRENGTH, COMMUNITY, RELISH</h1>
                            <h1 className="lead mb40 h1">Experience Fitness Perfectly Crafted for You</h1>
                            <Link to="/find-a-gym" className="btn btn-xl btn-white mb0">
                                Find an XTHRIVE.fit NEAR YOU
                            </Link>
                        </div>
                    </div>
                </div>
